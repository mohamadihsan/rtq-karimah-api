...
(company_id, company_name_var, email_var, phone_number_var, fax_number_var, address_text, logo_var, account_number_var, account_name_var, bank_account_var, active_status_boo, created_on_dtm, created_by_int, updated_on_dtm, updated_by_int, deleted_on_dtm, deleted_by_int)
...
(gender_id, gender_name_var, active_status_boo, created_on_dtm, created_by_int, updated_on_dtm, updated_by_int, deleted_on_dtm, deleted_by_int)
...
(position_id, position_name_var, level_order_int, active_status_boo, created_on_dtm, created_by_int, updated_on_dtm, updated_by_int, deleted_on_dtm, deleted_by_int)
